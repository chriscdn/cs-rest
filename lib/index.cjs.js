...
var require$$1$1 = require('lodash.get');
...
var require$$0$3 = require('is-object');
...
var nodes$1 = session => ({
  ...
  async addDocument ({
    ...
    {
      // node.js
      const fsp = require$$2__default['default'].promises;
...
const isObject = require$$0__default$3['default'];
