...
var require$$0 = _interopDefault(require('form-data'));
var require$$0$1 = _interopDefault(require('fs'));
var require$$1 = _interopDefault(require('path'));
var isnil = _interopDefault(require('lodash.isnil'));
var require$$0$2 = _interopDefault(require('uuid'));
var isObject = _interopDefault(require('is-object'));
var sha1 = _interopDefault(require('sha1'));
var Semaphore = _interopDefault(require('@chriscdn/promise-semaphore'));

var formDataFactory = {
	createFormData() {
		 {
			const klass = require$$0;
			return new klass
		}		
	}
};
...
var nodes = session => ({
	...
	async addDocument(parent_id, fileHandler, fileName = null) {
...

		{
			...
			const fsp = require$$0$1.promises;
