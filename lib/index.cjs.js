...
const axios = require$$0__default$1['default'];
const get$2 = require$$1__default['default'];
	...
	if (otcsticket) {
		...
		instance.interceptors.request.use(async request => {
			...
			if (request.headers.common['OTCSTicket']) {
				...
				const response = await axios.post(`${options.baseURL}/api/v1/auth/`, formData.getBuffer(), { headers: formData.getHeaders() }) ;
...
const assert$1 = require$$1__default$1['default'];
const SubTypes = require$$2;
...
var nodes$1 = session => ({
	...
	async addDocument({
		...
		{
			// node.js
			const fsp = require$$4__default['default'].promises;
			const path = require$$5__default['default'];
...
const assert = require$$1__default$1['default'];
...
const isObject = require$$0__default$2['default'];
...
class CustomError$1 extends Error {
	constructor(message = ErrorCodes$1.INTERNALERROR.message, data = null, code = ErrorCodes$1.INTERNALERROR.code) {
...
const get$1 = require$$1__default['default'];
...
var rpcClient$1 = class RPCClient {
...
const isnil = require$$10__default['default'];
const rpcClient = rpcClient$1;
