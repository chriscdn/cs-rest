            ...
            while (1) {
              switch (_context6.prev = _context6.next) {
                case 0:
                  ...
                  assert__default['default'](dataid != null, 'dataid cannot be null');
                  assert__default['default'](!isNaN(number_to_keep), 'number_to_keep must be an integer'); // delete parameters not supported
