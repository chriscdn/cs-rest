  ...
  var members = function members(session) {
    return {
      ...
      userQuery: function userQuery(query) {
        ...
        return session.get("/api/v2/members", {
          params: params
        });
      },
      member: function member(id) {
        return session.get("/api/v2/members/".concat(id));
      }
    };
  };
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 8:
                  f = _context.sent;
                  name = fileName || path.basename(fileHandler);
                  formData.append('file', f, name); // formData.append('name', name)
                ...
                case 14:
                  ...
                  // 
                  _name = fileName || fileHandler.name;
                  formData.append('file', fileHandler, _name); // formData.append('name', fileHandler.name)
