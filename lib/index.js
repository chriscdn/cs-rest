(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('core-js/modules/es.array.is-array.js'), require('core-js/modules/es.function.name.js'), require('core-js/modules/es.object.entries.js'), require('core-js/modules/es.symbol.js'), require('core-js/modules/es.symbol.description.js'), require('core-js/modules/es.symbol.async-iterator.js'), require('core-js/modules/es.symbol.iterator.js'), require('core-js/modules/es.symbol.to-string-tag.js'), require('core-js/modules/es.array.for-each.js'), require('core-js/modules/es.array.iterator.js'), require('core-js/modules/es.array.reverse.js'), require('core-js/modules/es.array.slice.js'), require('core-js/modules/es.date.to-string.js'), require('core-js/modules/es.json.to-string-tag.js'), require('core-js/modules/es.math.to-string-tag.js'), require('core-js/modules/es.object.create.js'), require('core-js/modules/es.object.define-property.js'), require('core-js/modules/es.object.get-prototype-of.js'), require('core-js/modules/es.object.set-prototype-of.js'), require('core-js/modules/es.object.to-string.js'), require('core-js/modules/es.promise.js'), require('core-js/modules/es.regexp.to-string.js'), require('core-js/modules/es.string.iterator.js'), require('core-js/modules/web.dom-collections.for-each.js'), require('core-js/modules/web.dom-collections.iterator.js'), require('axios'), require('core-js/modules/es.array.map.js'), require('core-js/modules/es.array.splice.js'), require('core-js/modules/es.regexp.constructor.js'), require('core-js/modules/es.regexp.exec.js'), require('core-js/modules/es.string.replace.js'), require('core-js/modules/es.array.concat.js'), require('core-js/modules/es.date.now.js'), require('core-js/modules/es.array-buffer.slice.js'), require('core-js/modules/es.function.bind.js'), require('core-js/modules/es.typed-array.uint8-array.js'), require('core-js/modules/es.typed-array.copy-within.js'), require('core-js/modules/es.typed-array.every.js'), require('core-js/modules/es.typed-array.fill.js'), require('core-js/modules/es.typed-array.filter.js'), require('core-js/modules/es.typed-array.find.js'), require('core-js/modules/es.typed-array.find-index.js'), require('core-js/modules/es.typed-array.for-each.js'), require('core-js/modules/es.typed-array.includes.js'), require('core-js/modules/es.typed-array.index-of.js'), require('core-js/modules/es.typed-array.iterator.js'), require('core-js/modules/es.typed-array.join.js'), require('core-js/modules/es.typed-array.last-index-of.js'), require('core-js/modules/es.typed-array.map.js'), require('core-js/modules/es.typed-array.reduce.js'), require('core-js/modules/es.typed-array.reduce-right.js'), require('core-js/modules/es.typed-array.reverse.js'), require('core-js/modules/es.typed-array.set.js'), require('core-js/modules/es.typed-array.slice.js'), require('core-js/modules/es.typed-array.some.js'), require('core-js/modules/es.typed-array.sort.js'), require('core-js/modules/es.typed-array.subarray.js'), require('core-js/modules/es.typed-array.to-locale-string.js'), require('core-js/modules/es.typed-array.to-string.js'), require('core-js/modules/es.parse-int.js'), require('core-js/modules/es.typed-array.uint32-array.js'), require('core-js/modules/es.array.join.js'), require('core-js/modules/es.number.constructor.js'), require('core-js/modules/web.timers.js')) :
  typeof define === 'function' && define.amd ? define(['exports', 'core-js/modules/es.array.is-array.js', 'core-js/modules/es.function.name.js', 'core-js/modules/es.object.entries.js', 'core-js/modules/es.symbol.js', 'core-js/modules/es.symbol.description.js', 'core-js/modules/es.symbol.async-iterator.js', 'core-js/modules/es.symbol.iterator.js', 'core-js/modules/es.symbol.to-string-tag.js', 'core-js/modules/es.array.for-each.js', 'core-js/modules/es.array.iterator.js', 'core-js/modules/es.array.reverse.js', 'core-js/modules/es.array.slice.js', 'core-js/modules/es.date.to-string.js', 'core-js/modules/es.json.to-string-tag.js', 'core-js/modules/es.math.to-string-tag.js', 'core-js/modules/es.object.create.js', 'core-js/modules/es.object.define-property.js', 'core-js/modules/es.object.get-prototype-of.js', 'core-js/modules/es.object.set-prototype-of.js', 'core-js/modules/es.object.to-string.js', 'core-js/modules/es.promise.js', 'core-js/modules/es.regexp.to-string.js', 'core-js/modules/es.string.iterator.js', 'core-js/modules/web.dom-collections.for-each.js', 'core-js/modules/web.dom-collections.iterator.js', 'axios', 'core-js/modules/es.array.map.js', 'core-js/modules/es.array.splice.js', 'core-js/modules/es.regexp.constructor.js', 'core-js/modules/es.regexp.exec.js', 'core-js/modules/es.string.replace.js', 'core-js/modules/es.array.concat.js', 'core-js/modules/es.date.now.js', 'core-js/modules/es.array-buffer.slice.js', 'core-js/modules/es.function.bind.js', 'core-js/modules/es.typed-array.uint8-array.js', 'core-js/modules/es.typed-array.copy-within.js', 'core-js/modules/es.typed-array.every.js', 'core-js/modules/es.typed-array.fill.js', 'core-js/modules/es.typed-array.filter.js', 'core-js/modules/es.typed-array.find.js', 'core-js/modules/es.typed-array.find-index.js', 'core-js/modules/es.typed-array.for-each.js', 'core-js/modules/es.typed-array.includes.js', 'core-js/modules/es.typed-array.index-of.js', 'core-js/modules/es.typed-array.iterator.js', 'core-js/modules/es.typed-array.join.js', 'core-js/modules/es.typed-array.last-index-of.js', 'core-js/modules/es.typed-array.map.js', 'core-js/modules/es.typed-array.reduce.js', 'core-js/modules/es.typed-array.reduce-right.js', 'core-js/modules/es.typed-array.reverse.js', 'core-js/modules/es.typed-array.set.js', 'core-js/modules/es.typed-array.slice.js', 'core-js/modules/es.typed-array.some.js', 'core-js/modules/es.typed-array.sort.js', 'core-js/modules/es.typed-array.subarray.js', 'core-js/modules/es.typed-array.to-locale-string.js', 'core-js/modules/es.typed-array.to-string.js', 'core-js/modules/es.parse-int.js', 'core-js/modules/es.typed-array.uint32-array.js', 'core-js/modules/es.array.join.js', 'core-js/modules/es.number.constructor.js', 'core-js/modules/web.timers.js'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.CSREST = {}, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, global.axios));
}(this, (function (exports, es_array_isArray_js, es_function_name_js, es_object_entries_js, es_symbol_js, es_symbol_description_js, es_symbol_asyncIterator_js, es_symbol_iterator_js, es_symbol_toStringTag_js, es_array_forEach_js, es_array_iterator_js, es_array_reverse_js, es_array_slice_js, es_date_toString_js, es_json_toStringTag_js, es_math_toStringTag_js, es_object_create_js, es_object_defineProperty_js, es_object_getPrototypeOf_js, es_object_setPrototypeOf_js, es_object_toString_js, es_promise_js, es_regexp_toString_js, es_string_iterator_js, web_domCollections_forEach_js, web_domCollections_iterator_js, axios) { 'use strict';
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  id = _args.length > 2 && _args[2] !== undefined ? _args[2] : uuidv4();
                  _context.next = 4;
  ...
  var sha1$1 = createCommonjsModule(function (module) {
    (function () {
      var crypt$1 = crypt,
          utf8 = charenc_1.utf8,
          bin = charenc_1.bin,
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  key = sha1$1(JSON.stringify(args));
                  _context.prev = 2;
                  _context.next = 5;
