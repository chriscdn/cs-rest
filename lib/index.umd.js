(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('core-js/modules/es.object.entries.js'), require('core-js/modules/es.function.name.js'), require('core-js/modules/es.symbol.js'), require('core-js/modules/es.symbol.description.js'), require('core-js/modules/es.object.to-string.js'), require('core-js/modules/es.symbol.iterator.js'), require('core-js/modules/es.array.iterator.js'), require('core-js/modules/es.string.iterator.js'), require('core-js/modules/web.dom-collections.iterator.js'), require('core-js/modules/es.symbol.async-iterator.js'), require('core-js/modules/es.symbol.to-string-tag.js'), require('core-js/modules/es.json.to-string-tag.js'), require('core-js/modules/es.math.to-string-tag.js'), require('core-js/modules/es.object.get-prototype-of.js'), require('core-js/modules/es.promise.js'), require('core-js/modules/es.regexp.to-string.js'), require('core-js/modules/web.dom-collections.for-each.js'), require('core-js/modules/es.array.slice.js'), require('axios'), require('core-js/modules/es.regexp.exec.js'), require('core-js/modules/es.regexp.constructor.js'), require('core-js/modules/es.string.replace.js'), require('core-js/modules/es.array.splice.js'), require('core-js/modules/es.array.map.js'), require('core-js/modules/es.array.includes.js'), require('core-js/modules/es.array.concat.js'), require('assert')) :
	typeof define === 'function' && define.amd ? define(['exports', 'core-js/modules/es.object.entries.js', 'core-js/modules/es.function.name.js', 'core-js/modules/es.symbol.js', 'core-js/modules/es.symbol.description.js', 'core-js/modules/es.object.to-string.js', 'core-js/modules/es.symbol.iterator.js', 'core-js/modules/es.array.iterator.js', 'core-js/modules/es.string.iterator.js', 'core-js/modules/web.dom-collections.iterator.js', 'core-js/modules/es.symbol.async-iterator.js', 'core-js/modules/es.symbol.to-string-tag.js', 'core-js/modules/es.json.to-string-tag.js', 'core-js/modules/es.math.to-string-tag.js', 'core-js/modules/es.object.get-prototype-of.js', 'core-js/modules/es.promise.js', 'core-js/modules/es.regexp.to-string.js', 'core-js/modules/web.dom-collections.for-each.js', 'core-js/modules/es.array.slice.js', 'axios', 'core-js/modules/es.regexp.exec.js', 'core-js/modules/es.regexp.constructor.js', 'core-js/modules/es.string.replace.js', 'core-js/modules/es.array.splice.js', 'core-js/modules/es.array.map.js', 'core-js/modules/es.array.includes.js', 'core-js/modules/es.array.concat.js', 'assert'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.CSREST = {}, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, global.axios, null, null, null, null, null, null, null, global.require$$1));
}(this, (function (exports, es_object_entries_js, es_function_name_js, es_symbol_js, es_symbol_description_js, es_object_toString_js, es_symbol_iterator_js, es_array_iterator_js, es_string_iterator_js, web_domCollections_iterator_js, es_symbol_asyncIterator_js, es_symbol_toStringTag_js, es_json_toStringTag_js, es_math_toStringTag_js, es_object_getPrototypeOf_js, es_promise_js, es_regexp_toString_js, web_domCollections_forEach_js, es_array_slice_js, require$$0, es_regexp_exec_js, es_regexp_constructor_js, es_string_replace_js, es_array_splice_js, es_array_map_js, es_array_includes_js, es_array_concat_js, require$$1) { 'use strict';
	...
	var assert$1 = require$$1__default['default'];
	var SubTypes = require$$2;
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                ...
	                assert$1(parent_id != null, 'parent_id cannot be null');
	                assert$1(fileHandler != null, 'fileHandler cannot be null');
	                assert$1(['v1', 'v2'].includes(apiVersion), "apiVersion must be in ['v1','v2']");
	...
	var versions$1 = function versions(session) {
	  return {
	    ...
	    promote: function promote(_ref2) {
	      return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
	        var dataid, versionNumber, _ref2$description, description, url;

	        return regeneratorRuntime.wrap(function _callee4$(_context4) {
	          while (1) {
	            switch (_context4.prev = _context4.next) {
	              case 0:
	                dataid = _ref2.dataid, versionNumber = _ref2.versionNumber, _ref2$description = _ref2.description, description = _ref2$description === void 0 ? null : _ref2$description;
	                assert(dataid != null, 'dataid cannot be null');
	                ...
	                return _context4.abrupt("return", session.postBody(url, _objectSpread2({}, !!description && {
	                  description: description
	                })));
	    ...
	    deleteVersion: function deleteVersion(_ref3) {
	      return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
	        var dataid, versionNumber, _ref3$apiVersion, apiVersion, url;

	        return regeneratorRuntime.wrap(function _callee5$(_context5) {
	          while (1) {
	            switch (_context5.prev = _context5.next) {
	              case 0:
	                dataid = _ref3.dataid, versionNumber = _ref3.versionNumber, _ref3$apiVersion = _ref3.apiVersion, apiVersion = _ref3$apiVersion === void 0 ? 'v1' : _ref3$apiVersion;
	                assert(dataid != null, 'dataid cannot be null');
	                assert(versionNumber != null, 'number_to_keep must be an integer');
	                url = "api/".concat(apiVersion, "/nodes/").concat(dataid, "/versions/").concat(versionNumber); // careful with deleteForm or deleteBody

	                return _context5.abrupt("return", session.delete(url));
	    ...
	    purge: function purge(_ref4) {
	      return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
	        var dataid, _ref4$number_to_keep, number_to_keep, url;

	        return regeneratorRuntime.wrap(function _callee6$(_context6) {
	          while (1) {
	            switch (_context6.prev = _context6.next) {
	              case 0:
	                dataid = _ref4.dataid, _ref4$number_to_keep = _ref4.number_to_keep, number_to_keep = _ref4$number_to_keep === void 0 ? 1 : _ref4$number_to_keep;
	                assert(dataid != null, 'dataid cannot be null');
	                assert(!isNaN(number_to_keep), 'number_to_keep must be an integer'); // delete parameters not supported
	                // https://stackoverflow.com/questions/51069552/axios-delete-request-with-body-and-headers
	                // number_to_keep is ignored

	                url = "api/v2/nodes/".concat(dataid, "/versions");
	                return _context6.abrupt("return", session.deleteForm(url, {
	...
	var Session_1$1 = /*#__PURE__*/function () {
	  ...
	  _createClass(Session, [{
	    ...
	    value: function rpcClient() {
	      ...
	      return new _rpcClient(this, baseURL);
	    }
	  }, {
	    key: "_isObject",
